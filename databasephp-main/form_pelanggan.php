  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="jk" name="jk" value="L" type="radio" class="form-control" <?php if (isset($_POST['idedit'])) {
        if ($row['jk'] == "L") {
        echo "checked";
        }
        } ?>>Laki-Laki
        <input id="jk" name="jk"value="P" type="radio" class="form-control"<?php if (isset($_POST['idedit'])) {
        if ($row['jk'] == "P") {
        echo "checked";
        }
        } ?>>Perempuan
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="tmp_lahir" name="tmp_lahir" type="text" class="form-control" value="<?php if (isset($_POST['idedit'])) {
        echo $row['tmp_lahir'];
        } ?>">
      </div>
    </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="tgl_lahir" name="tgl_lahir" type="date" class="form-control"value="<?php if (isset($_POST['idedit'])) {
        echo $row['tgl_lahir'];}
        ?>">
      </div>
    </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="email" name="email" type="email" class="form-control" value="<?php if (isset($_POST['idedit'])) {
        echo $row ['email'];
        }?>">
      </div>
    </div>
